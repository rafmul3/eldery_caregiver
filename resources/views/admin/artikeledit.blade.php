...
@section('isi')
    ...
    <section id="artikel">
        ...
        <div class="container">
            <center>
            <form action="{{ url('/artikel/update/'.$datas->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="row">
                                    <div class="row mt-2">
                                        <div class="col-mt-3"><label class="labels">Pengarang</label><input
                                                type="text" class="form-control" placeholder="Nama Pengarang" name="pengarang" required value="{{ $datas->pengarang }}">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-12"><label class="labels">Gambar
                                                Artikel</label>
                                                <input type="hidden" name='gambarLama' value="{{ $datas->gambar }}">
                                                @if ($datas->gambar)
                                                <img src="{{ asset('gambar_artikel/'.$datas->gambar) }}" alt="" class="img-preview img-fluid m-2 col-sm-5 d-block">
                                                @endif
                                        ...
                                        <div class="col-md-12"><label class="labels">Link Artikel</label><input
                                                type="text" class="form-control" placeholder="Link" name="link_artikel" required value="{{ $datas->link_artikel }}">
                                        </div>
