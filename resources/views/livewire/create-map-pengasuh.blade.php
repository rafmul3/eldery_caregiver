...
<div class="container mb-5">
    <div class="row justify-content-center">
        <div class="animate__animated animate__backInLeft col-5 pt-3">
            <form class="pt-5" action="/regispengasuh" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" placeholder="Masukkan Username Anda" required value={{ old('username') }} >
                ...
                <input type="hidden" name="status" value="pelamar">
    ...
    <div class="animate__animated animate__backInRight  col-4 pt-6">
        <div class="mx-auto " wire:ignore id='map' style='width: 600px; height: 600px; Margin-left: 10px; Margin-top: 300px'></div></div>
